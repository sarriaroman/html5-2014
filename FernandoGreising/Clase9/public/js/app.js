var app={
	...
	searchImagesHandler:function(e){
      ...
      HTTPSender.get(new HTTPObject('http://localhost:1338/images?q='+search,'json','GET',app.onLoadCallback));
  },
  onLoadCallback:function(object){
    app.clearImages();
     ...
     images.forEach(function(element,index,array){
         app.renderImage(element.url,index);
     });
   }
  },
  ...
  renderImage:function(url,i){
    var imageElement=document.createElement('img');
    var a=document.createElement('a');
    DOMUtil.addAttribute(a,'tabindex','1');
